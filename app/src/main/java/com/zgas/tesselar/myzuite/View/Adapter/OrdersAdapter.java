        ...
        public OrderViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.d(DEBUG_TAG, "Hora de entrada: " + timeIn);
                    //Log.d(DEBUG_TAG, timeSeen);
                    //Log.d(DEBUG_TAG, timeArrival);
                    Log.d(DEBUG_TAG, "Hora programada: " + timeProgrammed);
                    //Log.d(DEBUG_TAG, priority.toString());
                    ...
                    //bundle.putSerializable(MainActivity.EXTRA_JSON_OBJECT_TIME_ASSIGNMENT, timeIn);
                    //bundle.putSerializable(MainActivity.EXTRA_JSON_OBJECT_TIME_SEEN, timeSeen);
                    bundle.putSerializable(ExtrasHelper.EXTRA_JSON_OBJECT_TIME_ARRIVAL, timeArrival);
                    bundle.putSerializable(ExtrasHelper.EXTRA_JSON_OBJECT_TIME_PROGRAMMED, timeProgrammed);
                    bundle.putString(ExtrasHelper.EXTRA_JSON_OBJECT_PRIORITY, priority);
                    //bundle.putString(ExtrasHelper.EXTRA_USER_ID, userId);
                    bundle.putString(ExtrasHelper.EXTRA_JSON_OBJECT_USER_NAME, userName);

                    Log.d(DEBUG_TAG, "Id del caso: " + String.valueOf(id));
                    Log.d(DEBUG_TAG, "Dirección del caso: " + address);
                    Log.d(DEBUG_TAG, "Estatus del caso: " + String.valueOf(status));
                    Log.d(DEBUG_TAG, "Tipo de caso: " + String.valueOf(type));
                    Log.d(DEBUG_TAG, "Hora de caso: " + String.valueOf(timeIn));
                    //Log.d(DEBUG_TAG, "Hora de visualización de caso: " + String.valueOf(timeSeen));
                    //Log.d(DEBUG_TAG, "Hora de llegada del caso: " + String.valueOf(timeArrival));
                    Log.d(DEBUG_TAG, "Hora programada del caso: " + String.valueOf(timeProgrammed));
                    Log.d(DEBUG_TAG, "Prioridad del caso: " + String.valueOf(priority));
